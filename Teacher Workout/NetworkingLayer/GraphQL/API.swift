...
public struct LessonSaveInput: GraphQLMapConvertible {
    ...
    public var lessonId: GraphQLID {
        get {
            graphQLMap["lessonId"] as! GraphQLID
        }
        set {
...
public final class LessonsQuery: GraphQLQuery {
    ...
    public struct Data: GraphQLSelectionSet {
        ...
        public var lessons: Lesson? {
            get {
                (resultMap["lessons"] as? ResultMap).flatMap { Lesson(unsafeResultMap: $0) }
            }
            set {
        ...
        public struct Lesson: GraphQLSelectionSet {
            ...
            public struct Edge: GraphQLSelectionSet {
                ...
                public var node: Node {
                    get {
                        Node(unsafeResultMap: resultMap["node"]! as! ResultMap)
                    }
                    set {
                ...
                public struct Node: GraphQLSelectionSet {
                    ...
                    public var thumbnail: Thumbnail {
                        get {
                            Thumbnail(unsafeResultMap: resultMap["thumbnail"]! as! ResultMap)
                        }
                        set {
                    ...
                    public var theme: Theme {
                        get {
                            Theme(unsafeResultMap: resultMap["theme"]! as! ResultMap)
                        }
                        set {
                    ...
                    public var duration: Duration {
                        get {
                            Duration(unsafeResultMap: resultMap["duration"]! as! ResultMap)
                        }
                        set {
                    ...
                    public struct Duration: GraphQLSelectionSet {
                        ...
                        public var displayValue: String {
                            get {
                                resultMap["displayValue"]! as! String
                            }
                            set {
...
public final class SaveMutation: GraphQLMutation {
    ...
    public struct Data: GraphQLSelectionSet {
        ...
        public var lessonSave: LessonSave {
            get {
                LessonSave(unsafeResultMap: resultMap["lessonSave"]! as! ResultMap)
            }
            set {
        ...
        public struct LessonSave: GraphQLSelectionSet {
            ...
            public var lesson: Lesson {
                get {
                    Lesson(unsafeResultMap: resultMap["lesson"]! as! ResultMap)
                }
                set {
...
public final class ThemesQuery: GraphQLQuery {
    ...
    public struct Data: GraphQLSelectionSet {
        ...
        public var themes: Theme? {
            get {
                (resultMap["themes"] as? ResultMap).flatMap { Theme(unsafeResultMap: $0) }
            }
            set {
